...
# ;; Table of contents: imenu
# ;; 
# ;; imenu+? imenu-anywhere?
# ;; imenu using ido
# ;; Don't forget to add that to the specific mode...
# ;; Need to use M-x idomenu, but then it loses subsections...
# ;; (autoload 'idomenu "idomenu" nil t)
# ;; imenu-anywhere with C-.
# ;; (global-set-key (kbd "C-.") 'imenu-anywhere)
# (use-package imenu
# 	     :bind ("C-M-=" . imenu))	      ; C-M-= opens imenu
...
# ;; Buffer menu with C-x C-b
# (global-set-key (kbd "C-x C-b") 'buffer-menu)

# ;; Put this in a function?
# ;; 
# ;; List the buffers to always or never show (always override never)
...
# ;; *scratch* / *R* / *help[R](...)* / *[R]vignettes* / *magit:...* /
# ;; **shell...
# (defvar my-bs-always-show-regexps '("\\*scratch\\*" "\\*Packages\\*" "\\*R\\*" "^\\*help" "^\\*\\[R\\]vignettes" "^\\*magit:" "\\*shell")
...
# ;; Cycle through buffers: iflipb
# ;; http://www.emacswiki.org/emacs/iflipb
# (use-package iflipb
# 	     :config 
# 	     (progn
# 	       (setq
# 		iflipb-wrap-around 1	; Circular list
# 		iflipb-ignore-buffers 'my-bs-ignore-buffer ; List of buffers to ignore
# 		))
# 	     :bind (("<C-tab>" . iflipb-next-buffer) ; C-tab to switch to next buffer
# 		    ("<C-S-iso-lefttab>" . iflipb-previous-buffer))) ; C-S-tab to switch to previous buffer
...
bound to =C-F5=). Project-explorer is set to a width of 20
characters, and saves its cache in the =cache= folder:
...
(global-set-key [(control f5)] 'project-explorer-toggle)
#+END_SRC
...
# 	       ;; Org-babel to activate languages
...
# 		TeX-source-correlate-mode t	; Synxtex on (Ctrl+left mouse button 
# 					;   within a PDF document sends back 
# 					;   to the corresponding line of the 
# 					;   .tex source)
...
# 	     ;; 		(TeX-fold-mode 1)	; For outline views (hide/show sections, 
# 	     ;; 		(outline-minor-mode 1)	;   chapters, etc.)
...
# 	     ;; 		 TeX-command-default "LatexMk") ; LaTeXmk by default
# 	     ;; ;; Add the TOC in imenu
# 	     ;; (add-hook 'reftex-load-hook 'imenu-add-menubar-index)
# 	     ;; (add-hook 'reftex-mode-hook 'imenu-add-menubar-index)
# 	     ;; )
	     
# 	     (use-package company-auctex		; Autocompletion using Company
# 			  :ensure t
# 			  :config
# 			  (company-auctex-init)
# 			  )
...
# 			    (setq auctex-latexmk-inherit-TeX-PDF-mode t) ; Inherit PDF mode from AucTeX
# 			    ))		; Enable --pvc mode for continuous compilation
# 					;   Add this to .latexmkrc:
# 					;   $pdf_mode = 1;
# 					;   $pdf_previewer = 'start emacsclient';
	     
# 	     ;; (use-package latex-preview-pane       ; LaTeX Preview Pane
# 	     ;; 					; http://www.emacswiki.org/emacs/LaTeXPreviewPane
# 	     ;;   :init (latex-preview-pane-enable))	; Enable LaTeX Preview Pane
# 	     ;; ;; Can't make it work when opening a file... Needs to M-x latex-preview-pane-mode
