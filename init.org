...
#+BEGIN_SRC emacs-lisp
  (setq-default mode-line-format (list
                                  ...
                                  "      "
                                  ;; mode-line-position
                                  "%l:%c (%p)" ; line number : column number (percent) (does not work with PDF mode)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-S-s") 'counsel-yank-pop)
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'pdf-view-mode-hook 
            '(lambda ()
               (pdf-misc-size-indication-minor-mode) ; Show page number in mode line
               ...
               (define-key pdf-view-mode-map (kbd "f") 'pdf-view-fit-page-to-window) ; Fit page with 'p'
...
Add =journal= and =booktitle= to fields to be searched; fields to be
