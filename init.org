...
file names) with ~C-S-F5~, go to bookmarks with ~$~, and dynamically
filter files and folders with ~/~ (part of [[https://github.com/Fuco1/dired-hacks#dired-narrow][Dired-narrow]]):
...
Dired buffer to start with details displayed:
